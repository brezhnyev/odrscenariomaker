...
multimap<double, CanvasXODR::SValue> CanvasXODR::collectSValues(const t_road & odr_road)
{
    ...
    // add the s with the default resolution:
    for (double s = mXodrResolution; s < *odr_road._length; s += mXodrResolution)
